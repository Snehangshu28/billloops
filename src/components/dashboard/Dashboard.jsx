...
const Dashboard = () => {
  ...
  useEffect(() => {
    ...
    const unsub = onSnapshot(collection(db, 'tenants', tenantId, 'bills'), (snapshot) => {
      ...
      snapshot.docs.forEach(docSnap => {
        ...
        // Calculate total for each record (same as ShowRecords)
        ...
        const billTotal = subtotal - discountAmount + cgstAmount + sgstAmount;
        total += billTotal;
  ...
  // Replace widgets with live counts
  const widgets = [
    {
  ...
  // Render widgets at the top of the dashboard
  return (
